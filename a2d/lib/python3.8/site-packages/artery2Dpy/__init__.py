...
def output_ProfilesCurved(path):
...
def outputPointsFromDiameterTable_straightTube(path):
    x, yT, yB = output_ProfilesFlat(path)
    deltaZ = 0.001
...
def outputPointsFromDiameterTable_curvedTube(path):
    x, yT, yB = output_ProfilesCurved(path)
    deltaZ = 0.001
